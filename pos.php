<style>
    ...
    /* Override all dark/black background classes with your gradient */
    .bg-dark, 
    .bg-dark.bg-gradient,
    .bg-dark.bg-gradient.bg-opacity-25 {
        background: linear-gradient(45deg, #6366f1, #8b5cf6) !important;
        /* If bg-opacity-25 affects opacity, you may want to adjust opacity as well */
        /* opacity: 0.85; */ /* optional */
    }

    /* Thead row with dark bg */
    #item-list thead tr.bg-dark.bg-gradient.text-light {
        background: linear-gradient(45deg, #6366f1, #8b5cf6) !important;
    }
	#btn-tender {
    background-color: #10b981 !important; /* Tailwind's emerald-500 green */
...
#btn-tender:hover {
    ...
    /* Text color might need adjustment if background changes */
    .text-light {
        color: white !important;
    }
</style>
            ...
            <div class="card-body d-flex h-100 py-0 px-0">
                ...
                <div class="col-4 bg-dark d-flex flex-column bg-gradient h-100 p-2">
                    ...
                    <div class="pt-5 flex-grow-0">
                        ...
                        <button type="button" id="btn-tender" class="btn btn-primary w-100 mt-3">Tender</button>
                    </div>
                </div>
            </div>
        </div>
